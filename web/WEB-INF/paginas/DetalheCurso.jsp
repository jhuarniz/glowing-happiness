...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <p>Título do curso : ${curso.titulo}</p>
            <p>Descrição: ${curso.titulo}</p>
            ...
            <h1>Adicionar comentário ou recomendação:</h1>
            ...
            <form action="Executa" method="POST" class="form-group" >
                ...
                <div class="input-group">
                    <label for="comentario">Comentário ou recomendação</label>
                    <input type="text" name="comentario" class="form-control" placeholder="Insira seu comentário ou recomendação do curso" >
