...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div><h2>Bem vindo ao sistema cadastre a sua instituição!</h2></div>
            <form action="Executa" method="POST" class="form-group" >
                ...
                <div class="input-group">
                    ...
                    <input type="endereco" name="endereco" class="form-control" placeholder="endereço" >
                ...
                <input type="hidden" name="classe" value="NovaInstituicao">
                <input type="hidden" name="metodo" value="executa">

                <br>

                <div><h2>Realize seu login!</h2></div>
                <a href="index.jsp"> Clique aqui 
